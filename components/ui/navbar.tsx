    ...
    <div>
      <div className="p-6 md:p-10 flex items-center justify-between z-50">
        <div>
          <Link className="cursor-pointer" href="/">
            <Image
              ...
              width={100}
              height={200}
              className="w-100 h-100 md:w-140 md:h-140"
            />
           {/* <h1 className="text-gray-50">Kalekar Studio</h1>  */}
          </Link>
        </div>
        <div
        ...
        >
          ...
          <div onClick={scrollToGraphicDesign} className="hover:text-gray-50">Card Design</div>
